...
// Gère le formulaire et appelle POST /api/ai/generate
...
(function () {
  ...
  async function handleGenerateSubmit(event) {
    // Empêche TOUT rechargement
    event.preventDefault();
    event.stopPropagation();
    console.log("[generate.js] Submit intercepté, lancement génération…");
    ...
    // Validation minimale : il faut au moins objectif ou texte de départ
